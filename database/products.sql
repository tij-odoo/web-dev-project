...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2352608000ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="321">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dummy&table=users">`dummy`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dummy&table=products">`dummy`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dummy&table=images">`dummy`.`images`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dummy&table=category">`dummy`.`category`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=performance_schema&table=events_stages_current">`performance_schema`.`events_stages_current`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="44553c4e7b41664d5e3948265a247e52">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="321"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="dummy" targettable="images">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `images` (`p_id`, `image`) VALUES (&#039;5&#039;, &#039;roger and whitebeard clash.jpg&#039;), (&#039;6&#039;, &#039;assaassassination classroom.jpg&#039;), (&#039;7&#039;, &#039;nami wanted poster.jpg&#039;), (&#039;8&#039;, &#039;naruto kunai.jpg&#039;), (&#039;9&#039;, &#039;itachi ring.jpg&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="dummy" targettable="images">
                            <div class="action_content">
...
ORDER BY `images`.`p_id` ASC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="dummy" targettable="category">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `images`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="dummy" targettable="products">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `products`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="dummy" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
